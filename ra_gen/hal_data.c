...
const timer_cfg_t g_timer0_cfg =
{
    ...
    /* Actual period: 0.001 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x1770, .duty_cycle_counts = 0xbb8, .source_div = (timer_source_div_t)0,
    .channel             = 0,
...
{
    .scan_mask           = ADC_MASK_CHANNEL_1 | ADC_MASK_TEMPERATURE |  0,
    .scan_mask_group_b   =  0,
...
sci_uart_instance_ctrl_t     g_uart9_ctrl;
            ...
            {
                /* Baud rate calculated with 0.182% error. */ .semr_baudrate_bits_b.abcse = 0, .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 1, .mddr = (uint8_t) 157, .semr_baudrate_bits_b.brme = true
            };
